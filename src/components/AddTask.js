...
import { VALID_CATEGORIES, VALID_PRIORITIES } from "./Task";
...
export default function AddTask() {
    ...
    classNames = "flex gap-3 items-center flex-wrap";
    ...
    categoryDiv.appendChild(makeInput("category", categoryPicker));
    ...
    priorityDiv.appendChild(makeInput("priority", priorityPicker));
